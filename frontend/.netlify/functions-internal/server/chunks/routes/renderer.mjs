...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[{"src":"https://cdn.tailwindcss.com","tagPosition":"head"},{"src":"https://cdn.jsdelivr.net/npm/daisyui@latest","tagPosition":"head"}],"noscript":[]};
