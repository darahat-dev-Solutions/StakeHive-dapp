import { hasInjectionContext, getCurrentInstance, inject, ref, reactive, effectScope, isRef, isReactive, toRaw, getCurrentScope, onScopeDispose, watch, nextTick, toRefs, markRaw, computed, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, defineAsyncComponent, h, unref, shallowReactive, Suspense, Fragment, createApp, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, isReadonly, isShallow, mergeProps, withCtx, useSSRContext } from 'vue';
import { h as createError$1, k as klona, l as defuFn, m as hasProtocol, o as isScriptProtocol, q as joinURL, w as withQuery, s as sanitizeStatusCode, r as getContext, $ as $fetch$1, t as baseURL, v as createHooks, x as executeAsync, y as toRouteMatcher, z as createRouter$1, A as defu, B as destr, C as getRequestHeader, D as isEqual, E as setCookie, F as getCookie, G as deleteCookie } from '../_/nitro.mjs';
...
const web3_1XzoQtJcI3rvDwX0ojdx6AI2sCHgPrRGR_74D_0grWI = /* @__PURE__ */ defineNuxtPlugin(() => {
  let provider = null;
  let signer = null;
  return {
    provide: {
      web3Provider: {
        provider,
        // The BrowserProvider instance
        ethers,
        // Ethers library
        getSigner: () => signer || (provider == null ? void 0 : provider.getSigner())
        // Safe signer access
      }
    }
  };
...
const plugins = [
  ...
  web3_1XzoQtJcI3rvDwX0ojdx6AI2sCHgPrRGR_74D_0grWI,
...
export { _export_sfc as _, useNuxtApp as a, asyncDataDefaults as b, createError as c, useAppConfig as d, entry$1 as default, useRuntimeConfig as e, useRouter as f, nuxtLinkDefaults as g, defineStore as h, navigateTo as n, resolveRouteObject as r, useHead as u };
